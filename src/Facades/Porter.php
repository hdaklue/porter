...
/**
 * @method static void assign(\Hdaklue\Porter\Contracts\AssignableEntity $user, \Hdaklue\Porter\Contracts\RoleableEntity $target, string|\Hdaklue\Porter\Contracts\RoleInterface $role)
 ...
 * @method static bool hasRoleOn(\Hdaklue\Porter\Contracts\AssignableEntity $user, \Hdaklue\Porter\Contracts\RoleableEntity $target, string|\Hdaklue\Porter\Contracts\RoleInterface $role)
 ...
 * @method static \Hdaklue\Porter\Collections\Role\ParticipantsCollection getParticipants(\Hdaklue\Porter\Contracts\RoleableEntity $target)
 ...
 * @method static void changeRoleOn(\Hdaklue\Porter\Contracts\AssignableEntity $user, \Hdaklue\Porter\Contracts\RoleableEntity $target, string|\Hdaklue\Porter\Contracts\RoleInterface $role)
